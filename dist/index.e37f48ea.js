...
const controlSearchResults = async function() {
    try {
        ...
        if (!query) {
            (0, _resultsViewDefault.default).renderError("Please enter a value.");
            return;
        }
        // load search results
...
const controlAddBookmark = function() {
    ...
    _model.state.recipe.bookmarked ? _model.deleteBookmark(_model.state.recipe.id) : _model.addBookmark(_model.state.recipe);
    // update recipe view
    (0, _recipeViewDefault.default).update(_model.state.recipe);
    // render bookmarks
...
const init = function() {
    ...
    (0, _recipeViewDefault.default).addHandlerChangeServings(controlServings);
...
},{"core-js/modules/es.array.includes.js":"dkJzX","core-js/modules/web.immediate.js":"49tUX","./model":"Y4A21","./config":"k5Hzs","./views/recipeView":"l60JC","./views/searchView":"9OQAM","./views/resultsView":"cSbZE","./views/paginationView":"6z7bi","./views/bookmarksView":"4Lqzq","./views/addRecipeView":"i6DNj","regenerator-runtime/runtime":"dXNgZ","regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dkJzX":[function(require,module,exports) {
"use strict";
...
const KEY = "109ee167-3d94-47a3-8257-2e60374bf644";
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerChangeServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            const btn = e.target.closest(".btn--change-servings");
            if (!btn) return;
        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--change-servings btn--decrease-servings" data-update-to="${this._data.servings - 1}">
                <svg>
                  <use href="${0, _iconsSvgDefault.default}#icon-minus-circle"></use>
                </svg>
              </button>
              <button class="btn--tiny btn--change-servings btn--increase-servings" data-update-to="${this._data.servings + 1}">
                <svg>
