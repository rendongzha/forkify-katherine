        ...
        <div class="recipe__details">
          ...
          <div class="recipe__info">
            ...
            <div class="recipe__info-buttons">
              <button class="btn--tiny btn--change-servings btn--decrease-servings" data-update-to="${
              ...
              <button class="btn--tiny btn--change-servings btn--increase-servings" data-update-to="${
                this._data.servings + 1
              }">
                <svg>
